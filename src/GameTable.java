...
Dhruv K. Saligram
10/13/18
This class displays the game table
*/
...
public class GameTable extends JFrame implements ActionListener {
    ...
    private final String[] COLUMN_NAMES = {"Game Name", "Game Edition", "Publisher", "Exclusive Type", "Year Published", "Copies Sold"};
    ...
    public GameTable(Object[][] displayTable) {
        //Creating setup of frame below:
        super("Game Info");
        this.setBounds(0, 230, 1000, 200);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //If user closes table, disposing of current frame below:
